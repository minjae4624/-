...
<body>
    ...
    <div class="ui-layer">
        <div id="hud" class="interactive">
            <div class="player-hud p1-hud">
                ...
                <div id="p1-trans" class="transform-badge">HYBRID CHAINSAW MODE</div>
            </div>
    ...
    <script>
        // 캐릭터 7인 데이터 및 일러스트
        const CHARACTERS = {
            denji: { name: '덴지', color: 0xff0055, isHybrid: true, img: 'http://googleusercontent.com/image_collection/image_retrieval/5284260906072440914_0', type: '체인소 하이브리드' },
            power: { name: '파워', color: 0xff5500, isHybrid: false, img: 'http://googleusercontent.com/image_collection/image_retrieval/6851370321638739379_0', type: '혈액의 악마' },
            aki: { name: '아키', color: 0x0088ff, isHybrid: false, img: 'http://googleusercontent.com/image_collection/image_retrieval/3586354115942282614_0', type: '여우/커스 계약' },
            makima: { name: '마키마', color: 0xff00aa, isHybrid: false, img: 'http://googleusercontent.com/image_collection/image_retrieval/11239902871223266566_0', type
